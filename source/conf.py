...
htmlhelp_basename = 'UrbanTEP-API'
...
man_pages = [
    (master_doc, 'urbanthematicexploitationplatformapi', u'Urban Thematic Exploitation Platform API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'UrbanThematicExploitationPlatformAPI', u'Urban Thematic Exploitation Platform API Documentation',
     author, 'UrbanThematicExploitationPlatformAPI', 'One line description of project.',
     'Miscellaneous'),
]
...
# Github path
github_repo = "https://github.com/urban-tep/API"
